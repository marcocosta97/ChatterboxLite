 ...
 * @warning sono state aggiunte operazioni
 * 
...
typedef enum
{
    ...
    UNREGISTER_GROUP = 13, /* implementata anche l'eliminazione del gruppo */
     ...
     */
    OP_NOOP = 99, // messaggio di escape dalla routine (terminazione server)
